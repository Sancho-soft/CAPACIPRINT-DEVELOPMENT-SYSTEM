...
<div class="space-y-6 w-full">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <a href="{{ route('admin.users.index') }}" class="bg-[#111A24] rounded-2xl border border-slate-800/80 p-5 flex items-center justify-between shadow-lg hover:border-cyan-500/50 hover:bg-[#15202D] transition-all group cursor-pointer block">
            <div class="flex items-center gap-3.5 min-w-0">
                <i class="fa-solid fa-users text-2xl text-cyan-400 shrink-0 group-hover:scale-110 transition-all"></i>
        ...
        <a href="{{ route('management.branches.index') }}" class="bg-[#111A24] rounded-2xl border border-slate-800/80 p-5 flex items-center justify-between shadow-lg hover:border-indigo-500/50 hover:bg-[#15202D] transition-all group cursor-pointer block">
            <div class="flex items-center gap-3.5 min-w-0">
                <i class="fa-solid fa-store text-2xl text-indigo-400 shrink-0 group-hover:scale-110 transition-all"></i>
        ...
        <a href="{{ route('staff.print-requests.index') }}" class="bg-[#111A24] rounded-2xl border border-slate-800/80 p-5 flex items-center justify-between shadow-lg hover:border-amber-500/50 hover:bg-[#15202D] transition-all group cursor-pointer block">
            <div class="flex items-center gap-3.5 min-w-0">
                <i class="fa-solid fa-file-lines text-2xl text-amber-400 shrink-0 group-hover:scale-110 transition-all"></i>
        ...
        <a href="{{ route('management.orders.index') }}" class="bg-[#111A24] rounded-2xl border border-slate-800/80 p-5 flex items-center justify-between shadow-lg hover:border-emerald-500/50 hover:bg-[#15202D] transition-all group cursor-pointer block">
            <div class="flex items-center gap-3.5 min-w-0">
                <i class="fa-solid fa-bag-shopping text-2xl text-emerald-400 shrink-0 group-hover:scale-110 transition-all"></i>
